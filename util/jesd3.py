...
#Changes include: Modified transmission checksum parsing that is friendly to CR/LF generated by Dos/Windows
...
if __name__ == "__main__":
    ...
    txchecksum=0
    txcheckstate=0 #State 0 is beginning. State 1 means we're inside of STX range. State 2 means we're in ETX range.
    ...
    with open(sys.argv[1], 'rb') as fh:
        while (byte := fh.read(1)):
            ...
            #counter+=1
        if txcheckstate==1:
            print("WARNING: End of file with no ETX detected")
        txchecksum=txchecksum & 0xffff
