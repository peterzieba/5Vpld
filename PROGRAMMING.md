...
* Open-Source Programmers:
  * These almost always rely upon snippets of information and observation of programmers rather than the formal programming specifications which are likely unobtainable or lost to time itself.
...
* ~~A special branch of~~ <a href="https://github.com/ole00/afterburner/">Afterburner (An arduino-based PLD programmer)</a> has experimental support for these chips.
